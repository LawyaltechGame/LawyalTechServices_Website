...
const EmailTemplates = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      <SEO 
        title="Email Campaigns & Newsletters for Law Firms — Lawyal Tech"
        description="Email campaigns and newsletters for law firms by Lawyal Tech: lifecycle sequences, newsletters, and templates that drive consultations and demos."
        ...
        openGraph={{
          ...
          title: 'Email Campaigns & Newsletters for Law Firms — Lawyal Tech',
          description: 'Email marketing for law firms: plan, write, design, and automate programs that convert.'
        }}
      />
      <JsonLd data={{
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <ScrollAnimationWrapper animationType="slideUp" delay={0.35}>
          <div className="bg-white rounded-2xl p-8 shadow-xl mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-2 text-center">Signature Sequences</h2>
        ...
        <ScrollAnimationWrapper animationType="slideUp" delay={0.45}>
          <div className="bg-white rounded-2xl p-8 shadow-xl mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-2 text-center">Deliverables (per campaign/program)</h2>
            <div className="h-1 w-16 bg-[#D2DE26] rounded-full mx-auto mb-6"></div>
