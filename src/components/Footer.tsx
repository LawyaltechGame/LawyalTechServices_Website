          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
            ...
            <div className={`transition-all duration-800 ease-out delay-300 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-16 opacity-0'}`}>
              <nav className="flex flex-col gap-4">
                <a href="#" className="text-[#050706] text-lg font-medium hover:opacity-70 transition-opacity duration-300">
                  HOME
                </a>
                <a href="#" className="text-[#050706] text-lg font-medium hover:opacity-70 transition-opacity duration-300">
                  ABOUT
                ...
                <div className="relative group">
                  <a href="#" className="text-[#050706] text-lg font-medium hover:opacity-70 transition-opacity duration-300 flex items-center gap-1">
                    SERVICES
            ...
            <div className={`transition-all duration-800 ease-out delay-400 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-16 opacity-0'}`}>
              <div className="mb-4">
                <span className="text-[#050706] text-lg font-medium">SERVICES</span>
              </div>
              <nav className="flex flex-col gap-3">
                <a href="#" className="text-[#050706] text-base underline hover:opacity-70 transition-opacity duration-300">
                  Social Media
                </a>
                <a href="#" className="text-[#050706] text-base underline hover:opacity-70 transition-opacity duration-300">
                  PPC
            ...
            <div className={`transition-all duration-800 ease-out delay-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-16 opacity-0'}`}>
              <div className="mb-4">
                <span className="text-[#050706] text-lg font-medium">FOLLOW US:</span>
              </div>
              <div className="flex gap-4">
                <a href="#" className="text-[#050706] text-xl hover:opacity-70 transition-opacity duration-300">
                  f
                </a>
                <a href="#" className="text-[#050706] text-xl hover:opacity-70 transition-opacity duration-300">
                  @
